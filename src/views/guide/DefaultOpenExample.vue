<template>
<div>
    <div class="section__title">Render items with meta info</div>
    <p class="py-4 px-2">
        You could render your tree by setting a default open path
    ...
    <div class="p-4 bg-green-50">
        ...
        <vue3-router-tree v-else :items="routes" class="bg-purple-100 " :defaultOpen="'Components/Forms'">
            <template #item="{ item }">
...
export default {
    name: "DefaultOpenExample",
    data: () => ({
        code: snippets.DefaultOpenExample,
        showCode: false,
        items: [{
                header: "Preview",
            },
